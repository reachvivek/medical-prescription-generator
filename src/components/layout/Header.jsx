...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 px-3 sm:px-6 pt-3 sm:pt-4 animate-fade-in opacity-0">
      <div className="max-w-7xl mx-auto bg-white/80 backdrop-blur-lg rounded-full shadow-sm md:shadow-lg border border-gray-200/50 transition-all duration-300 hover:shadow-xl">
